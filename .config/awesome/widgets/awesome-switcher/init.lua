...
_M.settings = {
	preview_box = true,
	preview_box_bg = beautiful.bg_normal.."73",
	preview_box_border = beautiful.bg_normal.."00",
	preview_box_fps = 30,
	preview_box_delay = 150,
	preview_box_title_font = { "CQ Mono", "italic", "normal" },
	preview_box_title_font_size_factor = 0.8,
	preview_box_title_color = {252,241,227,1},
