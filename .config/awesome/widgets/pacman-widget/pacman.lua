...
config.interval = 600
config.popup_bg_color = beautiful.bg_normal
            ...
            local header = wibox.widget {
                {
                    nil,
                    {
                        markup = "<b>" .. (upgrading and "Updating " .. #upgrades_tbl .. " Packages..." or
                            (#upgrades_tbl == 0 and "No" or #upgrades_tbl) .. " Available Updates") .. "</b>",
