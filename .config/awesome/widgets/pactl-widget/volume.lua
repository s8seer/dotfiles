...
local function worker(user_args)
    ...
    volume.widget:buttons(
            awful.util.table.join(
                    awful.button({}, 1, function() volume:toggle() update_graphic(volume.widget) end),
                    awful.button({}, 2, function() volume:mixer() end),
                    --awful.button({}, 3, function() awful.util.spawn_with_shell('pavucontrol') update_graphic(volume.widget) end),
                    awful.button({}, 4, function() volume:inc() update_graphic(volume.widget) end),
                    awful.button({}, 5, function() volume:dec() update_graphic(volume.widget) end)
            )
    )
