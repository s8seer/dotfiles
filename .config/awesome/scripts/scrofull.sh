#!/bin/bash
scrot --quality=100 --thumb='160x90' --file=$HOME'/table/Media/Pictures/screenshots/scrot_%Y-%m-%d %H%M%S.png' --exec='notify-send "A Fullscreenshot has been taken." -t 2000 --icon="$m" ; rm "$m"'
