...
# Custom Config made by the Owner
...
# Preferences
gamer_class = ["steam_app_291550","hl2_linux","blushblush.exe","steam_app_1966900"]
group_font= 'agave'
nerd_font= 'Hurmit NF'
terminal = 'kitty'
wpname = 'decay_cat_ign_vaporWave.png'
wpaper = '~/.config/wallpapers/'+ wpname					# Must be DIR
