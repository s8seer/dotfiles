...
local function worker(user_args)
    ...
    local next_month_button = 4      -- local next_month_button = args.next_month_button or 4
    local previous_month_button = 5  -- local previous_month_button = args.previous_month_button or 5
